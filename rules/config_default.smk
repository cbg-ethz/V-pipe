        ...
        [
            ...
            (
                "applications",
                {
                    ...
                    "convert_reference": __RECORD__(
                        value="convert_reference", type=str
                    ),
            ...
            (
                "gunzip",
                {
                    "mem": __RECORD__(
                        value=32, type=int
                    ),  # gunzip stream its output to disk and requires close to no memory
            ...
            (
                "preprocessing",
                {
                    ...
                    "extra": __RECORD__(
                        value="-ns_max_n 4 -min_qual_mean 30 -trim_qual_left 30 -trim_qual_right 30 -trim_qual_window 10",
                        type=str,
                    ),
                },
            ),
            ...
            (
                "bwa_QA",
                {
                    ...
                    "threads": __RECORD__(value=0, type=int),
                    "conda": __RECORD__(value="", type=str),
                    "ref_panel": __RECORD__(
                        value="references/5-Virus-Mix.fasta", type=str
                    ),
                },
            ),
            (
                "coverage_QA",
                {
                    ...
                    "target": __RECORD__(
                        value="HXB2:6614-6812,7109-7217,7376-7478,7601-7634", type=str
                    ),
                },
            ),
            (
            ...
            (
                "ref_bwa_index",
                {
                    ...
                    "time": __RECORD__(value=235, type=int),
                    "conda": __RECORD__(
                        value=f"{VPIPE_BASEDIR}/envs/bwa_align.yaml", type=str
                    ),
                },
            ),
            (
            ...
            (
                "ref_bowtie_index",
                {
                    ...
                    "time": __RECORD__(value=235, type=int),
                    "conda": __RECORD__(
                        value=f"{VPIPE_BASEDIR}/envs/bowtie_align.yaml", type=str
                    ),
                },
            ),
            (
            ...
            (
                "consensus_bcftools",
                {
                    ...
                    "threads": __RECORD__(value=0, type=int),
                    "conda": __RECORD__(
                        value=f"{VPIPE_BASEDIR}/envs/bcftools.yaml", type=str
                    ),
            ...
            (
                "samtools_index",
                {
                    ...
                    "time": __RECORD__(value=20, type=int),
                    "conda": __RECORD__(
                        value=f"{VPIPE_BASEDIR}/envs/lofreq.yaml", type=str
                    ),
                },
            ),
            (
            ...
            (
                ...
                {
                    "conda": __RECORD__(
                        value=f"{VPIPE_BASEDIR}/envs/sam2bam.yaml", type=str
                    ),
                },
            ),
            (
            ...
            (
                "predicthaplo",
                {
                    ...
                    "time": __RECORD__(value=1435, type=int),
                    "threads": __RECORD__(value=0, type=int),
                    "read_min_length": __RECORD__(
                        value=0, type=int
                    ),  # TODO: make this a fraction (float) of read length
                    "conda": __RECORD__(
                        value=f"{VPIPE_BASEDIR}/envs/predicthaplo.yaml", type=str
                    ),
                },
            ),
            (
                "web_visualization",
                {
                    ...
                    "time": __RECORD__(value=235, type=int),
                    "conda": __RECORD__(
                        value=f"{VPIPE_BASEDIR}/envs/visualization.yaml", type=str
                    ),
                },
            ),
        ]
                ...
                try:
                    ...
                    if value == "threads" and section != "general":
                        cur_value = (
                            defaults.value
                            if defaults.value
                            else self.__members["general"]["threads"]
                        )
                    elif value == "conda":
                        cur_value = (
                            f"{VPIPE_BASEDIR}/envs/{section}.yaml"
                            if len(defaults.value) == 0
                            else defaults.value
                        )
                    else:
                    ...
                    raise ValueError(
                        "ERROR: Property '{}' of section '{}' has to be of type '{}', whereas you gave '{}'!".format(
                            value,
                            section,
                            defaults.type.__name__,
                            vpipe_configfile[section][value],
                        )
                    ) from err
            ...
            if vpipe_configfile.has_section(section):
                if vpipe_configfile.items(section):
                    raise ValueError(
                        ...
                        + ", ".join(
                            [option for option, _ in vpipe_configfile.items(section)]
                        )
                    )
                vpipe_configfile.remove_section(section)

        sections_left = {section for section, _ in vpipe_configfile.items()} - {
            "DEFAULT"
        }
        if sections_left:
            raise ValueError(
